...
2. Clone the Flask project from GitHub using the `git clone` command: `git clone https://github.com/Nick-Talton/cs4750.git`. This will create a folder named `flask-examples` that contains the project files.
